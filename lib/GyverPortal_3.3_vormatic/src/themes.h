...
".blockHeader{font-size:22px;color:#fff;border-radius:10px 10px 0px 0px;background-color:#ffd800;padding:6px 0px;margin:0 -11px 10px -11px;}\n"
...
"input[type=submit],input[type=button],button{height:55px;font-size:24px;width:90%;max-width:300px;margin:8px 5px;background-color:#ffd800;border:none;border-radius:8px;color:black;cursor:pointer;padding:0px 10px;}\n"
...
"input:checked+.slider{background-color:#ffd800}\n"
"input:checked+.slider:before{-webkit-transform:translateX(26px);-ms-transform:translateX(26px);transform:translateX(26px)}\n"
"output{display:inline-block;font-size:14px;padding:4px 3px;border-radius:4px;color:#fff;min-width:30px;background:#ffd800;margin-right:5px;}\n"
"input[type=range]{-webkit-appearance:none;width:70%;margin:12px 8px;height:12px;background:#fff;border:1px #b5b5b5 solid;border-radius:5px;background-repeat:no-repeat;cursor:pointer;padding:0px;background-image:linear-gradient(#ffd800,#ffd800);}\n"
...
".display{display:inline-block;font-size:18px;padding:3px 5px;border-radius:4px;color:#fff;background:#ffd800;margin:2px 3px;}\n"
"#ubtn{padding:0px 10px;height:40px;font-size:25px;margin:8px 5px;background-color:#ffd800;border:none;border-radius:8px;color:black;cursor:pointer;text-align:center;vertical-align:middle;}\n"
"#ubtn:hover{filter:brightness(0.9);}\n"
"#ubtnclr{height:0px;width:0px;overflow:hidden;}\n"
".navtab>ul{display:flex;flex-wrap:wrap;align-items:stretch;justify-content:center;list-style-type:none;margin:15px 0;padding:0;overflow:hidden;border-radius:5px;background:#ffd800;}\n"
".navtab>ul>li{display:flex;align-items:center;cursor:pointer;color:black;padding:8px 12px;}\n"
...
"#spinner input[type=number]{width:70px;border-radius:0px}\n"
"details>summary{font-size:18px;background-color:#ffd800;color:black;cursor:pointer;padding:10px 15px;border-radius:6px;user-select:none;}\n"
"details[open]>summary{border-radius:6px 6px 0 0;}\n"
"details>summary>*{display:inline;}\n"
"details>div{border:2px solid #ffd800;padding:10px;border-radius:0 0 4px 4px;}\n"
...
"input[type=button]:disabled,input[type=checkbox]:disabled+.slider:before,input[type=text]:disabled,input[type=number]:disabled,input[type=password]:disabled,"
"input[type=date]:disabled,input[type=time]:disabled,input[type=color]:disabled {filter:brightness(0.6);}\n"
...
"#blockBack input:checked+.slider{background-color:#ffd800}\n"
...
".blockTab{padding-top:0px;}\n"
".blockHeader{color:#000;font-size:22px;border-radius:10px 10px 0px 0px;background-color:#ffd800;padding:6px 0px;margin:0px -11px 10px -11px;}\n"
...
"textarea{max-width:300px}\n"
"input[type=submit],input[type=button],button{height:55px;font-size:24px;width:90%;max-width:300px;margin:8px 5px;background-color:#ffd800;border:none;border-radius:8px;color:black;cursor:pointer;}\n"
"input[type=submit]:hover,input[type=button]:hover,button:hover{filter:brightness(0.95 );}\n"
"input[type=button],button{display:flex;align-items:center;justify-content:center;}\n"
"input[type=submit]:active,input[type=button]:active,button:active{box-shadow:inset 0px 1px 6px #0007;}\n"
...
"input:checked+.slider:before{-webkit-transform:translateX(26px);-ms-transform:translateX(26px);transform:translateX(26px)}\n"
"output{display:inline-block;font-size:14px;padding:4px 3px;border-radius:4px;color:#fff;min-width:30px;background:#ffd800;margin-right:5px;}\n"
"input[type=range]{-webkit-appearance:none;width:70%;margin:12px 8px;height:12px;background:#2a2d35;border-radius:5px;background-repeat:no-repeat;cursor:pointer;padding:0px;background-image:linear-gradient(#ffd800,#ffd800);}\n"
"input[type=range]::-webkit-slider-thumb{-webkit-appearance:none;height:15px;width:15px;}\n"
"input[type=range]:hover{filter:brightness(0.93);}\n"
".display{display:inline-block;font-size:18px;padding:3px 5px;border-radius:4px;color:#fff;background:#ffd800;margin:2px 3px;}\n"
"#ubtn{padding:0px 10px;height:40px;font-size:25px;margin:8px 5px;background-color:#ffd800;border:none;border-radius:8px;color:black;cursor:pointer;text-align:center;vertical-align:middle;}\n"
